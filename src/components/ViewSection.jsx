...
const ViewSection = () => {
  ...
  return (
    <div className='w-full md:h-full  px-4 sm:px-8 lg:px-10 py-16'>
        <div className='relative  '>
            <img src={assets.hero} className='w-full h-[30vh] lg:h-[60vh] md:h-[40vh]  object-cover' alt="" />
            <div className='absolute inset-0 bg-black/30'></div>

            <div className='absolute inset-0 flex flex-col items-start justify-center text-start text-white px-15'>
